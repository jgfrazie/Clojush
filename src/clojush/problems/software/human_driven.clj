...
(def argmap
  ...
  ;;  :oracle-function gcd-solver
   ...
   :num-of-cases-used-for-output-selection 1000 ;; Check GP Fellowship slides for what to do here
   :num-of-cases-added-from-output-selection 5
   :num-of-cases-used-for-branch-coverage 1000 ;; Check GP Fellowship slides for what to do here
