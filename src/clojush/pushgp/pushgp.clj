...
(def evolved-solution-to-basement
  ;; Basement
  #_'({:close 0, :instruction in1} {:close 1, :instruction 1} {:close 1, :instruction integer_inc} {:close 0, :instruction exec_do*vector_integer} {:close 0, :instruction integer_add} {:close 0, :instruction []} {:close 0, :instruction integer_shove} {:close 0, :instruction integer_dup} {:close 0, :instruction integer_inc} {:close 0, :instruction exec_shove} {:close 1, :instruction exec_s} {:close 0, :instruction boolean_pop} {:close 0, :instruction vector_integer_first} {:close 0, :instruction integer_yankdup} {:close 0, :instruction exec_eq} {:close 0, :instruction integer_mult} {:close 0, :instruction vector_integer_dup_items} {:close 0, :instruction vector_integer_emptyvector} {:close 0, :instruction exec_y} {:close 1, :instruction vector_integer_stackdepth} {:close 1, :instruction in1} {:close 0, :instruction integer_stackdepth} {:close 0, :instruction integer_max} {:close 1, :instruction boolean_frominteger} {:close 2, :instruction integer_lt} {:close 0, :instruction tag_integer_926} {:close 0, :instruction in1} {:close 0, :instruction integer_inc} {:close 1, :instruction boolean_dup_items} {:close 1, :instruction exec_eq} {:close 0, :instruction integer_lt} {:close 0, :instruction boolean_dup_times} {:close 1, :instruction in1} {:close 0, :instruction []} {:close 0, :instruction integer_lte} {:close 0, :instruction integer_rot} {:close 0, :instruction 0} {:close 1, :instruction integer_mod} {:close 0, :instruction boolean_eq} {:close 1, :instruction exec_flush} {:close 0, :instruction integer_dup} {:close 0, :instruction integer_negate} {:close 0, :instruction exec_dup} {:close 0, :instruction vector_integer_shove} {:close 0, :instruction boolean_rot} {:close 0, :instruction exec_s} {:close 0, :instruction in1} {:close 0, :instruction boolean_dup_items} {:close 1, :instruction boolean_dup_times} {:close 0, :instruction in1} {:close 1, :instruction exec_y} {:close 1, :instruction 0} {:close 0, :instruction exec_rot} {:close 0, :instruction exec_yank} {:close 0, :instruction vector_integer_replacefirst} {:close 0, :instruction vector_integer_butlast} {:close 0, :instruction vector_integer_dup} {:close 1, :instruction vector_integer_first} {:close 0, :instruction vector_integer_rest} {:close 1, :instruction integer_stackdepth} {:close 0, :instruction exec_stackdepth} {:close 0, :instruction vector_integer_pop} {:close 1, :instruction integer_negate} {:close 1, :instruction exec_do*while} {:close 1, :instruction boolean_swap} {:close 0, :instruction in1} {:close 0, :instruction vector_integer_conj} {:close 0, :instruction exec_eq} {:close 0, :instruction vector_integer_shove} {:close 0, :instruction boolean_pop} {:close 1, :instruction exec_shove} {:close 1, :instruction 1} {:close 0, :instruction integer_mod} {:close 0, :instruction in1} {:close 1, :instruction in1} {:close 1, :instruction integer_pow} {:close 0, :instruction boolean_or} {:close 0, :instruction boolean_invert_first_then_and} {:close 0, :instruction 0} {:close 0, :instruction integer_gt} {:close 0, :instruction integer_yankdup} {:close 1, :instruction exec_when} {:close 1, :instruction in1} {:close 0, :instruction integer_inc} {:close 0, :instruction in1} {:close 0, :instruction vector_integer_conj} {:close 0, :instruction vector_integer_occurrencesof} {:close 0, :instruction integer_rot} {:close 0, :instruction boolean_pop} {:close 0, :instruction in1} {:close 1, :instruction exec_do*range} {:close 0, :instruction in1} {:close 0, :instruction integer_yankdup} {:close 0, :instruction integer_min} {:close 1, :instruction boolean_eq} {:close 0, :instruction vector_integer_eq} {:close 0, :instruction exec_shove} {:close 0, :instruction boolean_yankdup} {:close 0, :instruction in1} {:close 0, :instruction exec_eq} {:close 0, :instruction vector_integer_dup} {:close 0, :instruction integer_dup} {:close 0, :instruction exec_yank} {:close 0, :instruction integer_negate} {:close 0, :instruction 1} {:close 0, :instruction vector_integer_set} {:close 0, :instruction vector_integer_sort} {:close 0, :instruction vector_integer_set} {:close 0, :instruction in1} {:close 0, :instruction exec_when} {:close 0, :instruction []} {:close 0, :instruction vector_integer_dup} {:close 0, :instruction integer_lt} {:close 0, :instruction boolean_rot} {:close 0, :instruction in1} {:close 0, :instruction in1} {:close 0, :instruction integer_flush} {:close 0, :instruction vector_integer_concat} {:close 1, :instruction 1} {:close 0, :instruction in1} {:close 0, :instruction boolean_shove} {:close 1, :instruction integer_div} {:close 0, :instruction boolean_and} {:close 1, :instruction in1} {:close 0, :instruction exec_do*times} {:close 0, :instruction vector_integer_empty} {:close 0, :instruction in1} {:close 0, :instruction vector_integer_dup} {:close 0, :instruction integer_dup_times} {:close 0, :instruction vector_integer_subvec} {:close 0, :instruction integer_dec} {:close 0, :instruction in1} {:close 0, :instruction exec_pop} {:close 0, :instruction exec_dup_items} {:close 0, :instruction boolean_dup} {:close 0, :instruction exec_do*vector_integer} {:close 1, :instruction in1} {:close 0, :instruction boolean_rot} {:close 1, :instruction boolean_not} {:close 1, :instruction integer_swap} {:close 1, :instruction vector_integer_sort} {:close 0, :instruction in1} {:close 1, :instruction vector_integer_nth} {:close 2, :instruction in1} {:close 0, :instruction exec_if} {:close 0, :instruction integer_fromboolean} {:close 0, :instruction in1} {:close 1, :instruction in1} {:close 0, :instruction integer_pop} {:close 0, :instruction integer_lt} {:close 0, :instruction tag_exec_43} {:close 0, :instruction vector_integer_butlast} {:close 0, :instruction in1} {:close 0, :instruction integer_max} {:close 1, :instruction boolean_not} {:close 0, :instruction vector_integer_dup_times} {:close 0, :instruction vector_integer_yankdup} {:close 0, :instruction vector_integer_first} {:close 0, :instruction exec_yank} {:close 0, :instruction exec_flush} {:close 0, :instruction boolean_yankdup} {:close 0, :instruction in1} {:close 0, :instruction integer_lte} {:close 0, :instruction vector_integer_indexof} {:close 0, :instruction exec_empty} {:close 1, :instruction exec_do*times} {:close 0, :instruction in1} {:close 0, :instruction integer_negate} {:close 0, :instruction boolean_and} {:close 0, :instruction integer_dup_times} {:close 0, :instruction integer_inc} {:close 0, :instruction vector_integer_first} {:close 1, :instruction boolean_flush} {:close 1, :instruction boolean_dup} {:close 1, :instruction -1} {:close 1, :instruction in1} {:close 0, :instruction integer_yank} {:close 0, :instruction integer_swap} {:close 1, :instruction integer_max} {:close 0, :instruction in1} {:close 0, :instruction tag_vector_integer_549} {:close 0, :instruction exec_dup_items} {:close 0, :instruction boolean_empty} {:close 0, :instruction integer_fromboolean} {:close 1, :instruction integer_add} {:close 0, :instruction vector_integer_sort} {:close 0, :instruction exec_empty} {:close 0, :instruction integer_flush} {:close 1, :instruction integer_mult} {:close 0, :instruction vector_integer_dup} {:close 0, :instruction in1} {:close 0, :instruction integer_dup} {:close 1, :instruction integer_dec} {:close 0, :instruction exec_dup_times} {:close 0, :instruction vector_integer_conj} {:close 1, :instruction exec_yank} {:close 0, :instruction boolean_yankdup} {:close 1, :instruction integer_dup_items} {:close 0, :instruction exec_rot} {:close 1, :instruction integer_lte} {:close 0, :instruction vector_integer_last} {:close 0, :instruction exec_do*times} {:close 1, :instruction exec_do*count} {:close 1, :instruction 0} {:close 0, :instruction vector_integer_contains} {:close 0, :instruction exec_rot} {:close 0, :instruction in1} {:close 1, :instruction integer_yank} {:close 0, :instruction in1} {:close 0, :instruction integer_empty} {:close 0, :instruction integer_dup_items} {:close 0, :instruction []} {:close 0, :instruction vector_integer_rest} {:close 0, :instruction integer_rot} {:close 0, :instruction exec_while} {:close 1, :instruction -1} {:close 0, :instruction integer_mult} {:close 1, :instruction vector_integer_yank} {:close 1, :instruction integer_inc} {:close 0, :instruction integer_yank} {:close 0, :instruction integer_gt} {:close 0, :instruction vector_integer_yank})

  ;; Small or Large
  #_'({:close 0, :instruction ""}
      {:close 0, :instruction in1}
      {:close 0, :instruction 1000}
      {:close 0, :instruction integer_lt}
      {:close 0, :instruction exec_when}
      {:close 1, :instruction "small"} ;; should be "small"
      {:close 0, :instruction in1}
      {:close 0, :instruction 2000}
      {:close 0, :instruction integer_gte} ;; should be gte
      {:close 0, :instruction exec_when}
      {:close 1, :instruction "large"}
      {:close 0, :instruction print_string})

  ;; Compare string lengths
  '({:close 0, :instruction in1}
    {:close 0, :instruction string_length}
...
(defn make-pop-agents
  ...
  [{:keys [use-single-thread population-size
    ...
    :as argmap}]
  (let [population-agents (concat (vec (repeatedly population-size ;(dec population-size) ; need to remove dec TMH
                                                   #(genesis argmap)))
                                  #_[{:genome evolved-solution-to-basement
                                    :age 0
